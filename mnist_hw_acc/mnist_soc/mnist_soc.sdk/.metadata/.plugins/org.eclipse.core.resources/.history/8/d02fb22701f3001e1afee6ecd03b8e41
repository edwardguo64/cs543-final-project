...
float fc6_output0[10] = {0};
float fc6_output1[10] = {0};
float fc6_output2[10] = {0};
float fc6_output3[10] = {0};
float fc6_output4[10] = {0};
float fc6_output_1[10] = {0};
...
//	XLenet_cnn_Set_fc6_output_1(&accelerator, (u32)fc6_output1);
//	XLenet_cnn_Set_fc6_output_2(&accelerator, (u32)fc6_output2);
//	XLenet_cnn_Set_fc6_output_3(&accelerator, (u32)fc6_output3);
//	XLenet_cnn_Set_fc6_output_4(&accelerator, (u32)fc6_output4);
...
//		u32 offset_image = XLenet_cnn_Get_image_r(&accelerator);
//		u32 offset_parameters = XLenet_cnn_Get_parameters(&accelerator);
//		u32 offset_fc6_output = XLenet_cnn_Get_fc6_output(&accelerator);
//
//		xil_printf("Base offset set as %x %x %x on accelerator, from proc as %x %x %x\n\r", offset_image, offset_parameters, offset_fc6_output, (u32)**image, (u32)parameters, (u32)fc6_output);
...
//
//        fc6(conv5_output, fc6_weights, fc6_bias, fc6_output_1);
        //End inference here.

		//Stop the timer since the accelerator is done
//		timerCount_Stop = XTmrCtr_GetValue(&timer, 0);
//		if ((u64)total_time + (u64)(timerCount_Stop - timerCount_Start) > (u64)4294967295) {
//			overflow++;
//		}
//		total_time += (timerCount_Stop - timerCount_Start);
...
//            num_correct++;
	...
	//Display time
//	xil_printf("Time Accelerator: %u\n\r", total_time);
	cout << "Time Accelerator: " << total_time_acc << ", overflow: " << overflow_acc << endl;
	cout << "Time CPU: " << total_time << ", overflow: " << overflow << endl;
