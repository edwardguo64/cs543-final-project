...
HD_PWD='C:/cs543/mnist_hw_acc/mnist_soc/mnist_soc.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log mnist_bd_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source mnist_bd_wrapper.tcl -notrace
