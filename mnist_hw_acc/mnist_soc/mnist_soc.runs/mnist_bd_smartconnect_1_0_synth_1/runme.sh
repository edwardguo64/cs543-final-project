...
HD_PWD='C:/cs543/mnist_hw_acc/mnist_soc/mnist_soc.runs/mnist_bd_smartconnect_1_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mnist_bd_smartconnect_1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mnist_bd_smartconnect_1_0.tcl
