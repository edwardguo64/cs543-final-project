...
HD_PWD='C:/cs543/mnist_hw_acc/mnist_soc/mnist_soc.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mnist_bd_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mnist_bd_wrapper.tcl
