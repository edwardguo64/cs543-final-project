...
set_property used_in_implementation false [get_files -all C:/cs543/mnist_hw_acc/mnist_soc/mnist_soc.srcs/sources_1/bd/mnist_bd/mnist_bd_ooc.xdc]
...
synth_design -top mnist_bd_wrapper -part xc7z020clg400-1


# disable binary constraint mode for synth run checkpoints
set_param constraints.enableBinaryConstraints false
write_checkpoint -force -noxdef mnist_bd_wrapper.dcp
create_report "synth_1_synth_report_utilization_0" "report_utilization -file mnist_bd_wrapper_utilization_synth.rpt -pb mnist_bd_wrapper_utilization_synth.pb"
