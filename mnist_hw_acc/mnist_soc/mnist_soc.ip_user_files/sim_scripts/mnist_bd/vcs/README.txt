...
#
# Generated by export_simulation on Thu Apr 04 23:17:00 -0500 2024
#
################################################################################
...
'-reset_run' switch to the './mnist_bd.sh' script.

./mnist_bd.sh -reset_run
...
./mnist_bd.sh -noclean_files

For more information on the script, please type './mnist_bd.sh -help'.
