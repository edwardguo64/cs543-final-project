...
set Library     "hls"
set IPName      "lenet_cnn"
set Version     "1.0"
set DisplayName "Lenet_cnn"
set Revision    "2113521464"
...
set sdx_kernel_name "lenet_cnn"
set sdx_kernel_type ""
set sdx_kernel_files {}
set enable_xo_gen 0
set sdaccel_dir [file join [pwd] .. sdaccel]
set solution_dir "C:/cs543/mnist_hw_acc/lenet_cnn_hls/solution1"
set debug_dir [file join $solution_dir .debug]
set xo_hls_files_dir ""
set hdl_module_list {lenet_cnn_fadd_32bkb
...
set Interfaces {
    ...
    ap_clk {
        ...
        buses "s_axi_CTL m_axi_DATA_IMAGE m_axi_DATA_PARAMETERS m_axi_DATA_FC6_OUTPUT"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"
    ...
    m_axi_DATA_IMAGE {
        type "native_axim"
        mode "master"
        port_prefix "m_axi_DATA_IMAGE"
        data_width "32"
        param_prefix "C_M_AXI_DATA_IMAGE"
    ...
    m_axi_DATA_PARAMETERS {
        type "native_axim"
        mode "master"
        port_prefix "m_axi_DATA_PARAMETERS"
        data_width "32"
        param_prefix "C_M_AXI_DATA_PARAMETERS"
        port_width "AWADDR 32 AWID 1 AWUSER 1 WDATA 32 WSTRB 4 WID 1 WUSER 1 ARADDR 32 ARID 1 ARUSER 1 RDATA 32 RID 1 RUSER 1 BID 1 BUSER 1"
        ctype {
            AWLEN {
                Type "integer unsigned"
    ...
    m_axi_DATA_FC6_OUTPUT {
        type "native_axim"
        mode "master"
        port_prefix "m_axi_DATA_FC6_OUTPUT"
        data_width "32"
        param_prefix "C_M_AXI_DATA_FC6_OUTPUT"
        port_width "AWADDR 32 AWID 1 AWUSER 1 WDATA 32 WSTRB 4 WID 1 WUSER 1 ARADDR 32 ARID 1 ARUSER 1 RDATA 32 RID 1 RUSER 1 BID 1 BUSER 1"
        ctype {
            AWLEN {
                Type "integer unsigned"
...
## System Info
set user_parameters_list {clk_period 10 machine 64 combinational 0 latency 549064 II x}
