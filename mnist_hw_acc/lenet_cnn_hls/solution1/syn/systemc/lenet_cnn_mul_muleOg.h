...
// ==============================================================
#ifndef __lenet_cnn_mul_muleOg__HH__
#define __lenet_cnn_mul_muleOg__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(lenet_cnn_mul_muleOg) {
    ...
    SC_CTOR(lenet_cnn_mul_muleOg):  ACMP_smul_us_U ("ACMP_smul_us_U") {
